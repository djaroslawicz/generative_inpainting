...
recovered_audio_orig = invert_pretty_spectrogram(im, fft_size = fft_size,
...
""" plot spectrogram"""
def plotstft(audiopath, binsize=2**9-1, plotpath=None, colormap="jet"):
...
if __name__ == '__main__':
	...
	for composer in composer_list:
		if not os.path.exists('./reconstructed_spec/' + composer):
			os.makedirs('./reconstructed_spec/' + composer)
			print("made " + composer + ' directory!')
		source_dir = './reconstructed_wav/' + composer + '/'
		listing = sorted(glob.glob(source_dir + '*.wav'))
		for wav_file in listing:
